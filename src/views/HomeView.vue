<template xmlns="http://www.w3.org/1999/html">
  <div class="content bg">
    ...
    <dv-decoration-3 style="position: absolute;width:15%;height:40px;left: 10%;top: 1%;z-index: 3" />
    <dv-decoration-3 style="position: absolute;width:15%;height:40px;right: 10%;top: 1%;z-index: 3;cursor: pointer" />
    <dv-decoration-2 :reverse="true" style="position: absolute;width:1%;height:100%;left: 0;top: 1%;z-index: 3" />
    <dv-decoration-2 :reverse="true" style="position: absolute;width:1%;height:100%;right: 0;top: 1%;z-index: 3" />
